...
public abstract class CountDownTimerSuspended {
    ...
    private void createCountDownTimer() {
        countDownTimer = new CountDownTimer(millisRemaining, countDownInterval) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                com.example.memorygame.CountDownTimerSuspended.this.onTick(millisUntilFinished);
            }

            @Override
            public void onFinish() {
                com.example.memorygame.CountDownTimerSuspended.this.onFinish();
            }
        };
    }
     ...
     */
    public synchronized final com.example.memorygame.CountDownTimerSuspended start() {
        if (isPaused) {
